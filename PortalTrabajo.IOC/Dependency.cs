...
using PortalTrabajo.BLL.Services.Implementation;
using PortalTrabajo.IOC.Interceptors;
...
namespace PortalTrabajo.IOC
{
    public static class Dependency
    {
        public static void DependencyInjection(this IServiceCollection services , IConfiguration configuration)
        {
            ...
            services.AddDbContext<PortalTrabajoDbContext>((sp, options) =>
            {
            ...
            services.AddScoped<PortalTrabajo.BLL.Services.Contract.IReportesService, PortalTrabajo.BLL.Services.Implementation.ReportesService>();
