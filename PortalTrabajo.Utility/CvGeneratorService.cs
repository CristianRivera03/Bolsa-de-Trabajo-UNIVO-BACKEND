                    ...
                    page.Content().Row(row =>
                    {
                        row.ConstantItem(220) 
                           ...
                           .Column(col =>
                           {
                               ...
                               col.Item().PaddingTop(5).Text($"{perfil.Carnet}@univo.edu.sv").FontColor(Colors.White);
                               col.Item().PaddingTop(5).Text((perfil.DistritoNombre ?? "Sin ubicación")).FontColor(Colors.White);
