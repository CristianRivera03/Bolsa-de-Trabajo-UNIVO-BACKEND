    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<PerfilesEstudiante, PerfilEstudianteDTO>()
                ...
                .ForMember(destino => destino.MunicipioId, opt => opt.MapFrom(origen => origen.Distrito != null ? origen.Distrito.MunicipioId : (int?)null))
                .ForMember(destino => destino.DepartamentoId, opt => opt.MapFrom(origen => origen.Distrito != null ? origen.Distrito.Municipio.DepartamentoId : (int?)null));
            ...
            CreateMap<Empresa, EmpresaDTO>()
                .ForMember(dest => dest.Sector, opt => opt.MapFrom(src => src.Sector != null ? src.Sector.Nombre : null))
                .ForMember(dest => dest.DistritoNombre, opt => opt.MapFrom(src => src.Distrito != null ? src.Distrito.Nombre : null))
                .ForMember(dest => dest.MunicipioId, opt => opt.MapFrom(src => src.Distrito != null ? src.Distrito.MunicipioId : (int?)null))
                .ForMember(dest => dest.DepartamentoId, opt => opt.MapFrom(src => src.Distrito != null ? src.Distrito.Municipio.DepartamentoId : (int?)null))
            ...
            CreateMap<OfertasLaborale, OfertaLaboralDTO>()
                ...
                .ForMember(destino => destino.Carreras, opt => opt.MapFrom(origen => origen.OfertaCarreras.Select(c => c.Carrera.Nombre).ToList()))
            ...
            CreateMap<CatSectore, CatalogDTO>().ReverseMap();
            #endregion
        }
    }
}
