...
namespace PortalTrabajo.BLL.Services.Implementation
{
    public class CatalogoService : ICatalogoService
    {
        ...
        {
            var query = await _carreraRepo.Query(c => c.Activo == true).ToListAsync();
        ...
        {
            var entity = new CatSectore { Nombre = dto.Nombre };
        ...
        {
            var entity = new CatCarrera { Nombre = dto.Nombre, Activo = true };
