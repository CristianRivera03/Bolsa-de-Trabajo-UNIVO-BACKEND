                                ...
                                var cuerpoHtml = $@"
                                    ...
                                    <body style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
                                        <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px; background-color: #ffffff;'>
                                            <h2 style='color: #4f46e5; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px;'>¡Nueva Oferta de Trabajo de tu Interés!</h2>
                                            ...
                                            <p style='font-size: 0.75rem; color: #94a3b8; text-align: center;'>Si ya no deseas recibir notificaciones de ofertas de trabajo, puedes desactivarlas en la configuración de tu perfil.</p>
                                        </div>
                                    </body>
                                    </html>";
                                await emailService.EnviarCorreoAsync(email, asunto, cuerpoHtml);
                            }
