...
public partial class PortalTrabajoDbContext : DbContext
{
    ...
    public virtual DbSet<CatSectore> CatSectores { get; set; }
    ...
    public virtual DbSet<OfertaCarrera> OfertaCarreras { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CatSectore>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CatSecto__3214EC07496E32A3");
        ...
        modelBuilder.Entity<Empresa>(entity =>
        {
            ...
            entity.HasOne(d => d.Distrito).WithMany(p => p.Empresas)
                .HasForeignKey(d => d.DistritoId)
                .HasConstraintName("FK_Empresas_Distrito");

            entity.HasOne(d => d.Sector).WithMany(p => p.Empresas)
        ...
        modelBuilder.Entity<OfertaCarrera>(entity =>
        {
            entity.HasKey(e => new { e.OfertaId, e.CarreraId }).HasName("PK__OfertaCa__F186AF337FFF2F6D");

            entity.Property(e => e.Activo).HasDefaultValue(true);
            entity.Property(e => e.FechaCreacion).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.Carrera).WithMany(p => p.OfertaCarreras)
                .HasForeignKey(d => d.CarreraId)
                .HasConstraintName("FK_OfertaCarreras_Carrera");

            entity.HasOne(d => d.Oferta).WithMany(p => p.OfertaCarreras)
        ...
        modelBuilder.Entity<OfertasLaborale>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Activo, e.FechaExpiracion }, "IX_Ofertas_Activa");
        ...
        modelBuilder.Entity<PerfilesEstudiante>(entity =>
        {
            ...
            entity.HasOne(d => d.Distrito).WithMany(p => p.PerfilesEstudiantes)
                .HasForeignKey(d => d.DistritoId)
                .HasConstraintName("FK_PerfilesEstudiantes_Distrito");
