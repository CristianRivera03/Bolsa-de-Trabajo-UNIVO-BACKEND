        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordPortal = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ...
                    EstadoAcademico = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "Activo")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__AlumnosA__3214EC079F28C4A9", x => x.Id);
                });
